...
% [BwMHz]
% Bandwidth (MHz)
[phyParams,varargin]= addNewParam([],'BwMHz',13,'Bandwidth (MHz)','double',fileCfg,varargin{1});
...
[phyParams,varargin]= addNewParam(phyParams,'Ptx_dBm',10,'Transmitted power (dBm)','double',fileCfg,varargin{1});
