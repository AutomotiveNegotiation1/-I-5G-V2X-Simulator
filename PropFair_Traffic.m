...
[ the_BLER_curves  ] = init_load_BLER_curves_5G(CQI_mapper);
load('./BICM_k_d_MSE.mat','k','d');
CQI = 'range';
CQI_ini_1 = common_get_CQI_params_5G(CQI);
CQI_tables = common_get_CQI_params_5G(CQI_ini_1(1));

for i_= CQI_ini_1(1):CQI_ini_1(2)
     scheduler.CQI_tables(i_) = common_get_CQI_params_5G(i_);
end
