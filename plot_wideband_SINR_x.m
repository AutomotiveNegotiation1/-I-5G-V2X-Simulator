function plot_wideband_SINR()
  ...
  UE_wideband_SINR_axes        = axes('Parent',a_figure);
    ...
    legend('Cellular w.(ICIC+CS CoMP)','Cellular w. (ICIC)','Cellular w.o.(ICIC+CS CoMP)')
    grid(UE_wideband_SINR_axes,'on');
    title(UE_wideband_SINR_axes,'LTE UE wideband SINR');
    ...
    plot(UE_int_SINR_axes,inter_mat_ecdf_wo.x,inter_mat_ecdf_wo.f,'green');
        legend('Cellular w. (ICIC)','Cellular w.(ICIC+CS CoMP)','Cellular w.o.(ICIC+CS CoMP)')
    grid(UE_int_SINR_axes,'on');
    title(UE_int_SINR_axes,'LTE UE interference');
    xlabel(UE_int_SINR_axes,'UE interference [dB]');
