...
% Last Modified by GUIDE v2.5 10-Jul-2008 21:35:23
...
for k=1:valD
    ...
    [Hn Pn tn AoDn AoAn dBS dMS AoDm AoAm Fnm d thetaBS thetaMS OmegaBS OmegaMS thetav sigmaAS sigmaDS sigmaSF PLdB]=MultipathPol(3,d,valR,2,valS,valU,valdBS,valdMS,valv,valN,valM,valfc,BSAP,MSAP,valaBS,valbMS,valrn,valBSAS,valMSAS,valBSppD,valDS,0,0,valt,valX,vald,valthetaBS,valomegaBS,valthetav,valthetaMS,valomegaMS,pn,tn,cor);
    if BSAP==2
        valS=2*valS;
    else
    end
...
% Hints: get(hObject,'String') returns contents of txtBSppD as text
