...
% Last Modified by GUIDE v2.5 08-Jul-2008 13:49:43
...
for k=1:valD
    ...
    [Hn Pn tn AoDn AoAn dBS dMS AoDm AoAm Fnm d thetaBS thetaMS OmegaBS OmegaMS thetav sigmaAS sigmaDS sigmaSF PLdB]=Multipath(2,d,valR,2,valS,valU,valdBS,valdMS,valv,valN,valM,valfc,valBSAP,3,valBSAS,valMSAS,0,0,valrDS,valrAS,valt,valX,vald,valthetaBS,valomegaBS,valthetav,valthetaMS,valomegaMS,pn,tn,cor);
    H{k}=Hn;
    P{k}=Pn';
    AoD{k}=AoDn';
    AoA{k}=AoAn';
...
helpdlg('Choose the type of Base Station Antenna to use with the simulation. This will effect the Signal Reception through the Attenuation function. For more information go to the manual p.16-18','Base Station Antenna')
